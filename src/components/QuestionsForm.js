        ...
        <DialogContent sx={{ marginBottom: 2 }}>
          <div style={{ textAlign: 'center', }}>
            <DialogContentText id="alert-dialog-description">
              Hemos recibido tus preguntas para la Psic. Verónica Aragón. <br/>
...
export default function QuestionForm() {
  ...
  const handleSubmit = (event) => {
    ...
    fetch("https://incluyocdc-default-rtdb.firebaseio.com/registro/preguntas.json", {
      method: "POST",
      headers: {
        ...
        >
          ...
          <span style={{ textAlign: "center" }}>
            <Typography component="h1" variant="h5">
              ¡Envíanos tus preguntas sobre sexualidad!
            </Typography>
          </span>
          ...
          <span style={{ textAlign: "center", marginTop: "10px" }}>
            <Typography component="h1" variant="subtitle1" style={brStyle}>
              <b>
                ¿Qué es eso que siempre quisite saber sobre sexualidad
                pero nunca te animaste a preguntar? Puede ser sobre cualquier aspecto:
                salud sexual, placer, prácticas, beneficios, etc.
              </b>
              <br />
            </Typography>
          </span>
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12}>
                <FormControlLabel
                  ...
                  label={
                    <span>
                      Deseo preguntar de manera anónima.
                    </span>
                  }
                />
              </Grid>
